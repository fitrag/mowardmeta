<div class="relative" x-data="{ 
    ...
    >
        <button 
            ...
            @mouseover="if ($store.theme.current !== 'light') $el.style.backgroundColor='var(--bg-muted)'"
            @mouseout="if ($store.theme.current !== 'light') $el.style.backgroundColor='transparent'"
        >
